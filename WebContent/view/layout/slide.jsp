...
%>
<link rel="stylesheet"
	href="${rooturl}/resource/font-awesome/css/font-awesome.min.css">


<div id="managerslide">

	<aside class="app-sidebar" id="sidebar"
		style="height: auto; background-color: gray;">
		...
		<div class="sidebar-menu" style="background-color: gray;">
			<ul class="sidebar-nav">
				<li><a href="${rooturl }/view/layout/manager.jsp">
				...
				<c:if test="${rank==0 }">
					<li class="dropdown"><a
						href="${pageContext.request.contextPath}/ShowArticleListServlet?member_id=${user_id}&id=-1&pagenum=1"
						target="_blank">
							<div class="icon">
				...
				<c:if test="${rank==0 }">
					<li class="dropdown"><a href="#">
						...
						<div class="dropdown-menu">
							<ul>
								<li><a
									href="${pageContext.request.contextPath}/CategoryServlet">分类列表</a></li>
								<li><a
									href="${pageContext.request.contextPath}/ArticleServlet?pagenum=1">博客列表</a></li>
								<li><a
									href="${pageContext.request.contextPath}/view/article/newArticle.jsp">撰写博客</a></li>
					...
					<li class="dropdown"><a href="#">
						...
						<div class="dropdown-menu">
							<ul>
								<%-- 		<li><a href="${pageContext.request.contextPath}/ShowArticleListServlet?member_id=${user_id}&id=-1&pagenum=1" target="_blank">查看我的博客</a></li> --%>
								<li><a
									href="${pageContext.request.contextPath}/MessageServlet">留言管理</a></li>
								<li><a
									href="${pageContext.request.contextPath}/FileServlet?pagenum=1">资源管理</a></li>
								<li><a
									href="${pageContext.request.contextPath}/view/web/index.jsp">站点基本信息管理</a></li>
							</ul>
						</div></li>
				</c:if>
				...
				<c:if test="${rank == 1}">
					<li class="dropdown"><a
						href="${pageContext.request.contextPath}/ArticleServlet?pagenum=1">
							<div class="icon">
					...
					<!-- 定时器 -->
					<script>
                	var t2 = window.setInterval("listen()",5000);
                	 function listen() {
