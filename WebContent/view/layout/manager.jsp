<%@ page language="java" contentType="text/html; charset=utf-8"
    pageEncoding="utf-8" import ="java.text.SimpleDateFormat, java.util.Date, sdut.blog.dao.impl.*, java.util.ArrayList, sdut.blog.domain.Article, sdut.blog.utils.JDBCUtil,java.sql.*"%>
            ...
            <a class="card card-banner card-yellow-light" href="${rooturl}/UserServlet">
                <div class="card-body">
                    ...
                    <div class="content">
                        ...
                        %>
                        <div class="value"><span class="sign"></span><%=messagecount %></div>
                    </div>
                </div>
            </a>
        </div>
